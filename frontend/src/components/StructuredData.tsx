    ...
    switch (type) {
      case 'organization':
        return {
          ...
          url: data.url || 'https://cube-offline-pwa.preview.emergentagent.com',
          logo: data.logo || 'https://cube-offline-pwa.preview.emergentagent.com/logo.png',
          contactPoint: {
            '@type': 'ContactPoint',
      ...
      case 'article':
        return {
          ...
          publisher: {
            ...
            logo: {
              '@type': 'ImageObject',
              url: 'https://cube-offline-pwa.preview.emergentagent.com/logo.png',
            },
          },
      ...
      case 'event':
        return {
          ...
          organizer: {
            '@type': 'Organization',
            name: 'A-Cube Mental Health Platform',
            url: 'https://cube-offline-pwa.preview.emergentagent.com',
          },
